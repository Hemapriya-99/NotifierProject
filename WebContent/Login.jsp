...
<body >
  ...
  <div class="login-dark">
    ...
    <form name="form" action="LoginServlet" method="post" onsubmit="return validate()" style="text-align:center">
    ...
    <h2 class="sr-only">Login Form</h2>
            ...
            <a href="Register.jsp" class="forgot">New member? <span style="color:#2980ef">Sign Up</span></a></form>
    </div>
